...
if createOperation; then
  ...
  readParameter "WEBHOOK_URL - Please provide the url to be used by the agent to send webhooks for the environment.  The default is ${WEBHOOK_URL}:" WEBHOOK_URL "${WEBHOOK_URL}" "false"
else
  # Secrets are removed from the configurations during update operations ...
  printStatusMsg "Update operation detected ...\nSkipping the prompts for ADMIN_API_KEY, WEBHOOK_URL, WALLET_KEY, WALLET_SEED, and WALLET_DID secrets ... \n"
