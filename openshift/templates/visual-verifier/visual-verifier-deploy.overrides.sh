...
if createOperation; then
  ...
  parseHostnameParameter "OIDC_RP_PROVIDER_ENDPOINT" "OIDC_RP_PROVIDER_HOST"
  ...
  printStatusMsg "Getting OIDC_RP_PROVIDER_HOST for the ExternalNetwork definition from secret ...\n"
  writeParameter "OIDC_RP_PROVIDER_HOST" $(getSecret "${NAME}${SUFFIX}" "oidc-rp-provider-host") "false"
fi
