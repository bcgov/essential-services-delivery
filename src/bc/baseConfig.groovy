...
class baseConfig {
  ...
  public static final String[] DEPLOY_APPS = ['issuer-kit-db', 'issuer-kit-wallet', 'esr-web', 'safe-entry', 'visual-verifier', 'issuer-kit-web', 'issuer-kit-agent', 'issuer-kit-api']
}