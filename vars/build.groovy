...
void call(OpenShiftDSL openshift, String buildConfigName, int waitTimeout = 10, String contextDirectory = '', String envVars = '') {
  ...
  try {
    ...
    notifyRocketChat("Started the following builds on ${buildConfigName}; ${builds.names()} ...")
    ...
    notifyRocketChat("The builds for ${buildConfigName} failed.")
    throw(err)
  }

  echo "Builds complete ..."
  notifyRocketChat("All builds for ${buildConfigName} completed successfully.")
}